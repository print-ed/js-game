let play = new gameRestart(); //sets a new game which is then being called by a button in html file
function gameRestart() {
  // Start game
  this.innerfunc = function playGame() {
    // when this function is called then show the options
      ...
      let hidden = document.getElementById("hiddenHeader")
      let monsterEnd = document.getElementById("monster-win-button")
      let playerEnd = document.getElementById("player-win-button")
      monsterEnd.style.display = "none";
      playerEnd.style.display = "none";
  ...
  function diceGame () {
    ...
    let monster = document.getElementById("monster-win")
    let player = document.getElementById("player-win")
    let monsterEnd = document.getElementById("monster-win")
    let playerEnd = document.getElementById("player-win")
    monsterEnd.style.display = "none"
    playerEnd.style.display = "none"
    start.style.display = "none";
  ...
  function playerWon () {
    ...
    playerwon.innerHTML = "As you defeat the monster on his no sense game, you've never felt this fullfilled on your life before. You gathered all the items you could find and sets of to another adventure";
    // reloads the windows so it can restart.
    playerEnd.addEventListener('click', function(){
  ...
  function monsterWon() {
    ...
    monsterwon.innerHTML = "Your eyes felt heavy as you hold on to your last breath. The monster won. If only you had lived another life, what would you be today? you ask youself as you slowly drift away";
    monsterEnd.style.display = "flex";
    // reloads the windows so it can restart
    monsterEnd.addEventListener('click', function(){
      window.location.reload();
      return false;
    });
  }
